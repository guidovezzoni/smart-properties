...
internal class BaseFlavorKtTest {
    ...
    @Test
    fun `when buildConfigFieldString with keep syntax is called buildConfigField is called`() {
    ...
    @Test
    fun `when buildConfigFieldString without keep syntax is called buildConfigField is called`() {
    ...
    @Test
    fun `when resValueString with keep syntax is called resValue is called`() {
    ...
    @Test
    fun `when resValueString without keep syntax is called resValue is called`() {
